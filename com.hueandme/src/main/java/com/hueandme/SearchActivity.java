...
import com.hueandme.databinding.ActivitySearchBinding;
...
public class SearchActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private PHSDKListener mPHSDKListener = new PHSDKListener() {
        ...
        public void onAuthenticationRequired(PHAccessPoint accessPoint) {
            ...
            startActivity(new Intent(SearchActivity.this, ConnectActivity.class));
        }
            ...
            switch (code) {
                ...
                case PHHueError.BRIDGE_NOT_RESPONDING:
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            WizardAlertDialog.showErrorDialog(SearchActivity.this, message, android.R.string.ok);
                        }
                    });
                    break;
